# Fighting Force feasibility binding

## Identity

- Title and region: Fighting Force, USA.
- Serial: SLUS-00433.
- Source executable path: `disc/SLUS_004.33`.
- Load address: `0x801F8000`.
- Entry point: `0x801FBF00`.
- Source disc binding: ``.
...
The clean source commit is `631a6b50532a4328b424ca032a4f0c0b0450b258`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 68 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `631a6b50532a4328b424ca032a4f0c0b0450b258`.
- Portfolio `fighting-force/BUILDINFO.json`.
- Portfolio `fighting-force/RECEIPT.md`.
