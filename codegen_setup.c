...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Fighting Force",
    .project_root_env = "FIGHTING_FORCE_RECOMP_PROJECT_ROOT",
    .build_dir_env = "FIGHTING_FORCE_RECOMP_BUILD_DIR",
    .force_setup_env = "FIGHTING_FORCE_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_004.33_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Fighting_Force__Recompiled",
    .prepare_note =
